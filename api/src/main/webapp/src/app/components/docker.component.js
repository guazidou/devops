...
var DockerComponent = (function () {
    function DockerComponent(_loginService, _router) {
        this._loginService = _loginService;
        this._router = _router;
    }
    DockerComponent.prototype.ngOnInit = function () {
        if (this._loginService.loginStatus() == false) {
            this._router.navigate(['/login']);
            return;
        }
    };
    DockerComponent.prototype.goBack = function () {
        window.history.back();
    };
